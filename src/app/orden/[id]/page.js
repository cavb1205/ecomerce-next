    ...
    <div className="container mx-auto h-fit  my-14 p-6">
      ...
      <div className="bg-pink-100/40 rounded-lg p-4 my-4 flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4  w-full mx-auto mb-4">
          <h3 className="text-lg text-primary font-semibold">Producto</h3>
          <h3 className="text-lg text-primary font-semibold">Total</h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4  w-full mx-auto">
          <h3 className="text-md text-primary font-semibold">Envío</h3>
          <h3 className="text-md text-primary font-semibold">
            ${order.shipping_total}
          </h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4  w-full mx-auto">
          <h3 className="text-xl text-primary font-semibold">Total</h3>
          <h3 className="text-xl text-primary font-semibold">${order.total}</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4  w-full mx-auto">
          <h3 className="text-base text-secondary font-semibold">Metodo de pago</h3>
